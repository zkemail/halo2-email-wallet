...
use halo2_zk_email::utils::read_default_circuit_config_params;
...
//                 let email_substr_def =
//                     config.regex_config.regex_defs[0].substrs[self.email_addr_substr_id];
...
//                 }
//                 let shifted_chars =
//                     self.shift_variable(ctx, &gate, &regex_result.masked_characters, &shift_value);
